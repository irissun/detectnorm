...
#'
#' This dataset is generated by nonnormal data with function \code{rnonnorm}. It contains the descriptive data in individual studies in the meta-analysis.
#'
#' @format A \code{data.frame} with 40 studies:
#' \describe{
...
#'   \item{m1}{mean of group 1. Population mean is equal to 1. The data of group 1 is generated with skewness = 4 and kurtosis = 2. }
...
#'   \item{m2}{mean of group 2. Population mean is equal to 1.5. The data of group 2 is generated with skewness = -4 and kurtosis = 2. }
