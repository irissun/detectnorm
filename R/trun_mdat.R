...
#'
#' This dataset is generated by nonnormal data with function \code{truncnorm::rtruncnorm}. It contains the descriptive data in individual studies in the meta-analysis.
#'
...
#'   \item{m1}{mean of group 2. Population mean1 = 1.}
